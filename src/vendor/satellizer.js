...
(function (global, factory) {
        ...
        function Config() {
            ...
            this.providers = {
                facebook: {
                    ...
                    redirectUri: 'http://localhost:5000/api/facebook',
    ...
    var Local = (function () {
        ...
        Local.prototype.login = function (user, options) {
            ...
            options.url = options.url ? options.url : joinUrl("http://192.168.100.37:5000", this.SatellizerConfig.loginUrl);
        ...
        Local.prototype.signup = function (user, options) {
            if (options === void 0) { options = {}; }
            options.url = options.url ? options.url : joinUrl("http://192.168.100.37:5000", this.SatellizerConfig.signupUrl);
            options.data = user || options.data;
            options.method = options.method || 'POST';
            options.withCredentials = options.withCredentials || this.SatellizerConfig.withCredentials;
